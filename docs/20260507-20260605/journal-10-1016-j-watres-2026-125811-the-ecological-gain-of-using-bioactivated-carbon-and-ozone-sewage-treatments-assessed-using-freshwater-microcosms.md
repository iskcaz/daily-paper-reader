...
motivation: "研究动机：/g TOC), their combinations, and an untreated control。"
method: 摘要未明确说明实验设计、模型、样品或数据来源；需要查看正文确认方法细节。
result: "主要结果：Microbial communities in the water column showed pronounced treatment-dependent restructuring, and functional prediction indicated reduced representation of taxa involved in pollutant degradation and nitrogen cycling under high ozone conditions。"
conclusion: 结论意义：These findings highlight the importance of jointly considering chemical removal performance and ecological responses when selecting advanced wastewater treatment strategies。
---
