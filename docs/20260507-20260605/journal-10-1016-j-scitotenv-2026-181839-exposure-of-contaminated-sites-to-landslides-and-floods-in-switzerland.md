---
title: Exposure of contaminated sites to landslides and floods in Switzerland
authors: "Ariane Grimmer, Markus Mosimann, Andreas Zischg, Adrien Mestrot"
date: 2026-06-01
link: "https://doi.org/10.1016/j.scitotenv.2026.181839"
...
tldr: "Switzerland has around 38,000 registered contaminated sites, including deposit sites, operational sites, shooting ranges, and accident sites。"
source: journal
selection_source: journal_website_data
doi: 10.1016/j.scitotenv.2026.181839
...
motivation: "研究动机：Natural hazards are an effective pathway for remobilising contaminants from such sites - either by physical processes, such as erosion through landslides and dynamic floods, or by chemical processes through static floods。"
method: 摘要未明确说明实验设计、模型、样品或数据来源；需要查看正文确认方法细节。
result: "主要结果：Our study shows that due to the significant number of contaminated sites at risk of landslides, this natural hazard should also be considered when assessing the need for remediation。"
conclusion: "结论意义：In Switzerland, the exposure of contaminated sites to floods, and the associated remobilisation of contaminants, is included in the assessment of the need for remediation。"
---
