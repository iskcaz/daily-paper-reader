---
title: "FeS Colloids Trigger Antimony Redox Cycling, Colloid Formation, and Ultimate Fate during the Anoxic–Oxic Transition"
authors: "Yanxiang Yuan, John D. Fortner, Chenggang Ci, Anxu Sheng, Peng Liu, Hai-Bo Qin, Yi Jiang, Peng Liao"
date: 2026-06-20
link: "https://doi.org/10.1021/acs.est.6c02377"
tags: ["query:environmental-science", "query:journal-watch", "query:core-journal", "query:est", "query:EST"]
score: 6.0
evidence: 来自环境期刊监控：EST
tldr: "Antimony (Sb) mobility in subsurface environments is tightly coupled to iron (Fe) geochemistry, yet the roles of ferrous sulfide (FeS) colloids in controlling Sb fate across anoxic–oxic interfaces is not well understood。"
source: journal
selection_source: journal_website_data
doi: 10.1021/acs.est.6c02377
...
motivation: "研究动机：Antimony (Sb) mobility in subsurface environments is tightly coupled to iron (Fe) geochemistry, yet the roles of ferrous sulfide (FeS) colloids in controlling Sb fate across anoxic–oxic interfaces is not well understood。"
method: "方法：Spectroscopic analyses confirm that complete FeS oxidation results in the production of secondary Fe(III) (oxyhydr-)oxides, which sequester Sb(V) through combined surface adsorption and structural incorporation via isomorphous substitution。"
result: "主要结果：Experiments and theoretical calculations indicate that FeS both reduce Sb(V) and promote Sb(III) oxidation, with the dominant pathway determined by system redox conditions。"
