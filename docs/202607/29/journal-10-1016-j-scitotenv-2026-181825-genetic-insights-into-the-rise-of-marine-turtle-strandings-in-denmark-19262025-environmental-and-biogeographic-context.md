...
tldr: "Marine turtles are traditionally restricted to tropical and subtropical waters, where temperature regimes support their thermoregulation, navigation, and migratory behaviour。"
source: journal
...
motivation: "研究动机：Marine turtles are traditionally restricted to tropical and subtropical waters, where temperature regimes support their thermoregulation, navigation, and migratory behaviour。"
method: 摘要未明确说明实验设计、模型、样品或数据来源；需要查看正文确认方法细节。
result: 主要结果：Our results suggest that oceanographic conditions and cold-stunning during winter months may contribute to the increasing number of strandings observed in temperate waters。
conclusion: 结论意义：The recent rise in turtle strandings in Denmark highlights the importance of monitoring marine turtle occurrences at the northern limits of their distribution。
---
