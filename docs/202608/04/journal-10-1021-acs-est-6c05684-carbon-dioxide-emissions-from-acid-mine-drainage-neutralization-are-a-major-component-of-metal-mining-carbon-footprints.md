---
title: Carbon Dioxide Emissions from Acid Mine Drainage Neutralization Are a Major Component of Metal Mining Carbon Footprints
authors: "Stanisław Kołodziejski, Eva E. Stüeken, Laura Sánchez López, Jose Miguel Nieto, Carlos R. Cánovas, Rafael Pérez-López, Luke Bridgestock"
date: 2026-07-22
pdf: "https://pubs.acs.org/doi/pdf/10.1021/acs.est.6c05684?ref=article_openPDF"
link: "https://doi.org/10.1021/acs.est.6c05684"
tags: ["query:environmental-science", "query:journal-watch", "query:core-journal", "query:est", "query:EST"]
score: 6.0
evidence: 来自环境期刊监控：EST
tldr: High Resolution Image Download MS PowerPoint Slide Achieving the transition to net zero human greenhouse gas emissions requires a large increase in metal production by mining。
source: journal
...
motivation: "研究动机：However, continual oxidative weathering of waste sulfide minerals will increase AMD-related CO 2 emission budgets into the future。"
method: 摘要未明确说明实验设计、模型、样品或数据来源；需要查看正文确认方法细节。
result: "主要结果：Normalized to historic copper production rates, AMD-associated emissions (0.3–4.2 t CO 2 per t Cu) are of similar magnitude as conventional copper production carbon footprints (1–9 t CO 2 per t Cu)。"
conclusion: 结论意义：These findings highlight the need to account for AMD-related CO 2 emissions from metal mining to support the transition toward net zero greenhouse gas emissions。
---
