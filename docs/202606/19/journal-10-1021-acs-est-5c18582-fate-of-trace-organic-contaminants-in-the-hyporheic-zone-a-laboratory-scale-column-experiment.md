---
title: "Fate of Trace Organic Contaminants in the Hyporheic Zone: A Laboratory-Scale Column Experiment"
authors: "Edinsson Muñoz-Vega, Selina Hillmann, Mohammad Sajjad Abdighahroudi, Kai Ihle, Carolin Bertold, Christoph Schüth, Holger V. Lutze, Stephan Schulz"
date: 2026-06-16
pdf: "https://pubs.acs.org/doi/pdf/10.1021/acs.est.5c18582?ref=article_openPDF"
link: "https://doi.org/10.1021/acs.est.5c18582"
tags: ["query:environmental-science", "query:journal-watch", "query:core-journal", "query:est", "query:EST"]
score: 6.0
evidence: 来自环境期刊监控：EST
tldr: Rivers impacted by anthropogenic activities often contain numerous trace organic contaminants (TrOCs) that can infiltrate aquifers。
source: journal
selection_source: journal_website_data
doi: 10.1021/acs.est.5c18582
journal: "Environmental Science & Technology"
journal_label: EST
open_pdf_status: open_pdf
open_pdf_available: true
motivation: 研究动机：Rivers impacted by anthropogenic activities often contain numerous trace organic contaminants (TrOCs) that can infiltrate aquifers。
method: "方法：To differentiate between these two processes, we conducted long-term laboratory column experiments using riverbed sediments from a creek downstream of wastewater treatment plants to quantify the fate of several ubiquitous TrOCs with diverse physicochemical。"
result: 主要结果：Mass balances and comparisons between experiments revealed a variety of attenuation behaviors。
conclusion: "结论意义：These results suggest that while polluted hyporheic sediments of high organic matter content can temporarily reduce contaminant transport, their attenuation capacity is limited。"
---
