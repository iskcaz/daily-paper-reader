...
tldr: "超短链全氟与多氟烷基物质在环境中日益受关注，但其在造礁珊瑚中的赋存情况几乎空白。研究采集南海北部湾54份造礁珊瑚样品，系统测定多种USC-PFAS及其他传统、替代PFAS，并估算海水到珊瑚的生物富集因子。结果显示TFA、PFPrA和bis-FMeSI在珊瑚中广泛检出，其中TFA占总PFAS质量浓度的86%，且富集潜力明显。该工作首次证明USC-PFAS尤其TFA在造礁珊瑚中普遍存在，为评估珊瑚礁生态风险提供了关键依据。"
source: journal
...
motivation: USC-PFAS环境普遍存在且风险受关注，但其在造礁珊瑚中的分布与富集数据长期缺失。
method: 分析北部湾54份造礁珊瑚中的多种USC-PFAS及其他PFAS，并估算海水到珊瑚的对数生物富集因子。
result: "TFA、PFPrA、bis-FMeSI检出率分别为100%、74%、72%；TFA中位浓度23 ng/g dw，占总PFAS的86%。"
conclusion: 研究首次证实USC-PFAS尤其TFA在造礁珊瑚中广泛存在且具生物富集潜力，需进一步评估生态风险。
---
