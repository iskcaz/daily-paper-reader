---
title: "Beyond solubilization: Interface PAH biodegradation in nonaqueous-phase liquids treated with a plant biosurfactant"
authors: "Alicia Fernandez-Vazquez, Maria Jordán, Rosa Posada-Baquero, Joaquim Vila, Magdalena Grifoll, Jose-Julio Ortega-Calvo"
date: 2026-06-01
link: "https://doi.org/10.1016/j.jhazmat.2026.142169"
...
tldr: Biodegradation of polycyclic aromatic hydrocarbons (PAHs) in non-aqueous phase liquids (NAPLs) is constrained by limited bioavailability。
source: journal
selection_source: journal_website_data
doi: 10.1016/j.jhazmat.2026.142169
...
motivation: 研究动机：Biodegradation of polycyclic aromatic hydrocarbons (PAHs) in non-aqueous phase liquids (NAPLs) is constrained by limited bioavailability。
method: 方法：We investigated how Quillaja saponin affects PAH partitioning and biodegradation in biphasic NAPL systems using heptamethylnonane (HMN) and creosote/HMN mixtures with Mycobacterium gilvum and the microbial population from a creosote-polluted soil。
result: "主要结果：In creosote-containing NAPLs, saponin substantially enhanced PHE partitioning but did not increase degradation rates, which remained controlled by continuous intra-NAPL diffusion of multiple high-molecular-weight PAHs sustaining interfacial bacterial activity。"
conclusion: "结论意义：Our findings demonstrate that a dual mechanism combining solubilization and biostimulation offers a cost-effective, low-toxicity approach for sustainable remediation of persistent organic contaminants across diverse subsurface scenarios, from NAPL source。"
---
