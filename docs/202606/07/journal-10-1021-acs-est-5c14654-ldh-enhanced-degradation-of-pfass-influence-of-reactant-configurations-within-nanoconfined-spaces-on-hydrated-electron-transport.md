---
title: "LDH-Enhanced Degradation of PFASs: Influence of Reactant Configurations within Nanoconfined Spaces on Hydrated Electron Transport"
authors: "Jingyi Feng, Hao Lu, Jing Hua, Na Sun, Jing Jiang, Kun Qian, Qi Yu, Anfei He, Haoting Tian"
date: 2026-06-03
link: "https://doi.org/10.1021/acs.est.5c14654"
tags: ["query:environmental-science", "query:journal-watch", "query:core-journal", "query:est", "query:EST"]
score: 6.0
evidence: 来自环境期刊监控：EST
tldr: "水合电子还原是去除PFAS的重要路径，但在纳米限域空间中，前驱体与污染物的排布如何影响电子传输仍不清楚。本文将聚吲哚嵌入LDH层间作为水合电子前驱体，并同步富集PFOA，系统比较不同负载下的降解表现。结果发现，尽管聚吲哚增多会提高水合电子产率，PFOA降解速率却呈先升后降，并在27.2%负载时3小时内完全降解。分子动力学表明，限域构型会拉长部分电子到C-F键的传输距离，揭示产率提升与利用效率下降并存的“产率-传输”自拮抗机制。"
source: journal
...
motivation: 纳米限域可保护水合电子并缩短扩散，但前驱体与PFAS在限域内的构型对电子利用效率影响缺乏机制认知。
method: 在LDH层间原位合成聚吲哚作为水合电子前驱体，并借静电作用富集PFOA，结合降解实验与分子动力学分析传输过程。
result: "聚吲哚负载越高水合电子产率越大，但PFOA降解速率呈单峰变化，在27.2%负载时3小时内实现完全降解。"
conclusion: 限域内反应物排布决定水合电子到C-F键的传输距离与利用效率，为纳米限域PFAS还原体系优化提供设计依据。
---
